...
class World: commonItems::parser
{
  ...
  private:
	...
	// The save's date; every real save carries one. EU5's 1337 bookmark minus this year gives the
	// offset all converted dates shift by.
	date endDate = date("1337.4.1");
	...
	std::vector<std::string> traitsLookup; // the save's own trait table; trait numbers are 0-based positions in it
