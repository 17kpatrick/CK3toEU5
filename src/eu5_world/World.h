...
class World
{
  ...
  private:
	...
	// True when any owned location's dominant religion is Christian or Israelite - the gate
	// muslim_monarchy's dhimmi_abrahamic_communities privilege asks for.
	[[nodiscard]] bool hasAbrahamicMinorityLocations(const Country& country) const;
