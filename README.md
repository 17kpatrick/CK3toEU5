...
Point it at your `.ck3` save — manual saves, ironman and autosaves (including the compressed
exit autosave) all work; binary saves get melted automatically via rakaly. Let it run,
